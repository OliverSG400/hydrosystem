...
//            canvasPoint.x = GRID_MARGIN_LEFT + Math.round(point.x * scaleModifier);
//            canvasPoint.y = getHeight() - GRID_MARGIN_BOTTOM - Math.round(point.y);
...
//            graphPoint.x = (point.x / scaleModifier) - GRID_MARGIN_LEFT;
//            graphPoint.y = getHeight() - GRID_MARGIN_BOTTOM - (point.y);
